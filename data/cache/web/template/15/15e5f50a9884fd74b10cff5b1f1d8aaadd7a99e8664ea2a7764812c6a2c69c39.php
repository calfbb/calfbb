...
/* user/login.html */
class __TwigTemplate_804e503880bde93a5e37ef8db66d8f7a94ec1ac0d9a1b7897c165bad8142d17b extends Twig_Template
{
...
<div class=\"login-content\">
    <div class=\"s-area\">
        ...
        echo "?m=web&c=user&a=register\"><i></i><span>立即注册</span></a></li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
    layui.use('form', function(){
        ...
        // line 115
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["_G"]) ? $context["_G"] : null), "APP_URL", array(), "array"), "html", null, true);
        echo "?m=web&c=user&a=verifyUser\",
                type:'get',
    ...
    {
        return array (  152 => 126,  138 => 115,  91 => 71,  19 => 1,);
    }
...
<div class=\"login-content\">
    <div class=\"s-area\">
        <div class=\"login-form\">
            ...
            <div class=\"login-type\">
                <ul class=\"cl\">
                    <li class=\"fr link-reg\"><a href=\"{{ _G['APP_URL'] }}?m=web&c=user&a=register\"><i></i><span>立即注册</span></a></li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
    layui.use('form', function(){
        ...
        form.on('submit(formDemo)', function(data){
            ...
            \$.ajax({
                //脚本地址
                url:\"{{ _G['APP_URL'] }}?m=web&c=user&a=verifyUser\",
                type:'get',
                data:{nickname:data.field.username,password:data.field.password},
                dataType:'json',
                success:function(data){
...
</html>", "user/login.html", "C:\\wamp\\www\\lnmpbao\\web\\template\\user\\login.html");
    }
}
