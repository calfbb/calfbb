...
/* system/applist.html */
class __TwigTemplate_350749b65fbfe18656d311cab1f5578a21915db5edd331955123fac9f0ca20f1 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("system/index.html", "system/applist.html", 1);
        $this->blocks = array(
...
<script>
    ...
    layui.use('laypage', function(){
        ...
        echo "?m=web&c=system&a=appList&page=\"+obj.curr;
                }
        ...
        laypage.render({
            ...
            jump: function(obj, first){
                ...
                if(obj.curr !=\"{{_GPC['page']}}\"){
                    window.location.href=\"{{_G['APP_URL']}}?m=web&c=system&a=appList&page=\"+obj.curr;
                }
//                console.log(obj.curr); //得到当前页，以便向服务端请求对应页的数据。
//                console.log(obj.limit); //得到每页显示的条数
...
", "system/applist.html", "C:\\wamp\\www\\lnmpbao\\web\\template\\system\\applist.html");
    }
}
